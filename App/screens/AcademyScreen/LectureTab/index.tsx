...
import { lectureTabStyle } from './styles';
...
function LectureTab(): JSX.Element {

    return(
        <View style={{...globalStyle.outerViewWithTab, width:'100%'}}>
                ...
                <View style={{marginBottom: 15, width: '100%'}}>
                    <ImageBackground source={SampleImage} style={{width:'100%', height:130, borderRadius: 10}} resizeMode='cover'>
                        <View style={{...globalAlign.fill_contentCenter, ...globalFilter.darken}}>
                            <Text style={lectureTabStyle.headerTitle}>Prepared Lectures</Text>
                            <Text style={lectureTabStyle.headerContent}>[Hermetic Institutue] {'\n'}Provided Qualified Lectures</Text>
                        </View>
                    </ImageBackground>
                </View>
